package academy.renansereia.integration;
...
import academy.renansereia.wrapper.PageableResponse;
...
public class AnimeControllerIT {
    ...
    static class config {
        ...
        public TestRestTemplate testRestTemplateRoleUserCreator(@Value("${local.serve.port}") int port){
            RestTemplateBuilder renan = new RestTemplateBuilder().basicAuthentication("renan", "1010")
                    .rootUri("http://localhost:8080"+port);
            return new TestRestTemplate(renan);
        }
    }
